import { AppstoreOutlined, BarChartOutlined, ProjectOutlined, RocketOutlined, TeamOutlined } from '@ant-design/icons';
...
const HomePage: React.FC = () => {
        ...
        <Row gutter={[16, 16]}>
          {quickActions.map((action, index) => (
            <Col xs={24} sm={12} lg={8} key={index}>
              <Card className='action-card' hoverable onClick={action.action}>
  ...
  return (
    <div className='homepage-container'>
      <Tabs activeKey={activeTab} onChange={setActiveTab} size='large' className='homepage-tabs' items={tabItems} />
    </div>
  );
};
