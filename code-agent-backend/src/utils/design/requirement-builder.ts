...
function extractAnnotationNodes(
  annotation?: DesignComponentAnnotationEntity | null
  ...
  const visit = (node: any, depth: number) => {
    ...
    if (node.id) {
      summaries.push({
        ...
        ftaComponent:
          typeof node.ftaComponent === "string" ? node.ftaComponent : undefined,
        depth,
