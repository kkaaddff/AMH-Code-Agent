...
export class DesignDocumentEntity {
  ...
  @ApiProperty({ example: '登录页交互稿', required: false, description: '描述信息' })
  @prop()
  public description?: string

  @ApiProperty({ example: 'https://mastergo.com/goto/LhGgBAK', description: 'MasterGo 设计稿链接' })
  @prop()
  ...
  @ApiProperty({ example: 'active', enum: ['active', 'archived', 'deleted'], description: '状态' })
  @prop({ default: 'active' })
  public status: DesignDocumentStatus

  @ApiProperty({ example: 'oss://bucket/path/to/file.json', description: '原始设计稿 OSS 对象 Key' })
  @prop()
